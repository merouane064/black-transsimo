...
| New bookings not appearing in sheet | Confirm the tab is named exactly `Bookings` and row 1 has the 16 headers above. Check `Extensions → Apps Script → Executions` for errors. |
